...
- **An email, password, and username — only if you choose to create an
  account.** Creating an account is optional and lets your data follow
  you across devices. Your password is never stored in plain text; we
  only store a secure hash of it. Your username is a display name you
  pick — it doesn't need to be your real name. We don't use your email
  for anything besides account login and password resets.
